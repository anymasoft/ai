/**
 * Remove Framer badge/editor artifacts and inject defensive CSS + runtime script.
 * This is the core cleaning logic reused by both URL-export and local-file cleaning.
 */
export function cleanFramerHtml(html: string): string {
  // Remove Framer badge/editor artifacts
  html = html
