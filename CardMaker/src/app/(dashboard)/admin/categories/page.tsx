    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Управляй инструкциями для каждой категории товаров. Они уточняют, на какие характеристики акцентировать внимание при генерации описаний.
        </p>
      </div>
      ...
      {categories.length === 0 ? (
        ...
        <>
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              Промпты категорий применяются к генерации, когда пользователь выбирает соответствующую категорию. Если промпт пустой, блок будет пропущен.
            </AlertDescription>
          </Alert>
