...
const values = [
  {
    ...
    description: 'Система проверяет текст по всем требованиям маркетплейцов — от грамматики до структуры. Получите точный список ошибок, которые могут привести к отклонению карточки.'
  },
  {
    icon: Palette,
  ...
  {
    icon: Layout,
    title: 'Уверенность в соответствии требованиям маркетплейцов',
