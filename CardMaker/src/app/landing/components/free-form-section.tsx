          ...
          <div className="relative group">
            ...
            <div className="relative">
              <Textarea
                ...
                rows={8}
                className="resize-none rounded-2xl border-2 border-gradient-to-r from-primary/50 via-primary/30 to-primary/50 p-5 text-base bg-card transition-all duration-300 focus:border-primary focus:shadow-lg focus:shadow-primary/20 focus-visible:outline-none focus-visible:ring-0 hover:border-primary/70"
              />
