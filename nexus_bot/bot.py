...
"""
    ...
    async def btn_help(message: types.Message, state: FSMContext):
        ...
        help_text = """━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❓ Как писать запрос, чтобы видео получилось точным
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Главное:
• Сервис не "догадывается" сам.
• Пиши явно: кто движется, что статично, что с текстом, что с фоном.

────────────────────────────────────
1) Камера (по желанию) — пиши ПО-РУССКИ
────────────────────────────────────
Можно управлять камерой командами. Пиши одной строкой:
...
Если камеру не укажешь — будет статичная камера.

────────────────────────────────────
2) Движение людей / объектов — пиши ЯВНО
────────────────────────────────────
Укажи:
• кто движется
• кто НЕ движется
...
Если не написал — движение не гарантируется.

────────────────────────────────────
3) Фон — тоже укажи явно
────────────────────────────────────
Примеры:
• Фон статичный
• Фон не меняется
...
Подсказка:
• Если движется модель — обычно фон лучше сделать статичным (напиши это).
• Если товар статичен — фон можно анимировать (напиши это).

────────────────────────────────────
4) Текст / цена / логотип — если важно, обязательно запрети менять
────────────────────────────────────
Примеры:
...
────────────────────────────────────
5) Примеры (копируй и меняй)
────────────────────────────────────

Пример 1 — модели двигаются, текст статичен
Девушки на заднем плане идут и демонстрируют платья.
Текст на переднем плане не изменяется.
Фон статичный.
Камера статична.

Пример 2 — товар статичен, фон анимирован
Флакон с кремом стоит неподвижно в центре.
На заднем плане течёт ручей и движется зелень.
Текст и логотип не меняются.
Камера статична.

Пример 3 — движение камеры
