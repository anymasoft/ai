...
export type CodeGenerationModel = typeof CodeGenerationModel[keyof typeof CodeGenerationModel]

// Will generate a static error if a model in the enum above is not in the descriptions
export const CODE_GENERATION_MODEL_DESCRIPTIONS: Record<CodeGenerationModel, { name: string; inBeta: boolean }> = {
