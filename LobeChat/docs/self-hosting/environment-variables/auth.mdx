...
- Default: `-`
- Example: `pk_test_<your_publishable_key>` in dev / `pk_live_<your_publishable_key>` in production
...
- Default: `-`
- Example: `sk_test_<your_secret_key>` in dev / `sk_live_<your_secret_key>` in production
