...
export async function POST(
  ...
  try {
    ...
    const systemPrompt = usingFallback
      ? "Ты — эксперт по анализу вовлеченности аудитории YouTube. Твоя задача — выявить паттерны высокого engagement на основе поведенческих метрик (просмотры, скорость роста, формат, тема), так как данные лайков/комментариев недоступны. ВАЖНО: Отвечай СТРОГО на русском языке. Возвращай JSON с английскими ключами, но ВСЕ значения должны быть на русском языке."
      : "Ты — эксперт по анализу вовлеченности аудитории YouTube. Твоя задача — выявить паттерны высокого engagement. ВАЖНО: Отвечай СТРОГО на русском языке. Возвращай JSON с английскими ключами, но ВСЕ значения должны быть на русском языке.";
