  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "Ты — эксперт по анализу YouTube контента. Твоя задача — выявить паттерны успешных видео. ВАЖНО: Отвечай СТРОГО на русском языке. Возвращай JSON с английскими ключами, но ВСЕ значения должны быть на русском языке."
        },
        {
          role: "user",
