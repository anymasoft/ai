      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Больше не нужно часами вручную изучать чужие каналы, сохранять ролики и надеяться, что идея выстрелит. Мы берём то, что уже набирает просмотры в вашей нише, и превращаем это в готовый сценарий — за вас.
          </p>
        </div>
