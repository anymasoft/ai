      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center mb-16">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-6">
            Перестаньте гадать, что снимать дальше
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            Большинство авторов тратят часы на поиск идей, смотрят конкурентов и всё равно не уверены, что ролик зайдёт.
            Мы делаем это системно: собираем данные по вашей нише, анализируем успешные видео и превращаем их в готовые сценарии, которые можно сразу использовать.
          </p>
        </div>
