...
# Каждое исправление или доработку ОБЯЗАТЕЛЬНО документировать, дополняя этот файл
# Ничего не изменять в папке extension/ и в других папках, все изменения и доработки - только в папке ai/token-auth-system
# Документация разработки OAuth Token Flow
